  ...
  local function LoadVerticalZoom()
    ...
    local ext_name = "Vertical zoom 3_TR_code"
    local TR_code = reaper.GetExtState(ext_name,"Vertical zoom 3_TR_code",false)
    
    local ext_name = "Vertical zoom 3_TR_TCPH"
    local TR_TCPH = reaper.GetExtState(ext_name,"Vertical zoom 3_TR_TCPH",false)
