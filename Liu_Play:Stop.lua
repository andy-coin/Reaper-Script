  ...
  local function ChangeBufferSize()
      ...
      for abi=1,reaper.CountTracks(0) do
          ...
          if  reaper.GetMediaTrackInfo_Value(tr,"I_RECARM")==1 
          and reaper.GetMediaTrackInfo_Value(tr,"I_RECMON")==1 then
  ...
  local function ChangeScreenSet()
      ...
      if p_n==1 then
         ...
         elseif tonumber(Screen)~=40454 and Screen~="" then
         ...
         elseif tonumber(Screen)~=40457 and Screen~="" then
  ...
  local function main()
    ...
    if 5 == Play then
       ...
       --reaper.Undo_EndBlock("Stop recording and create track version",-1)
    ...
    elseif Play == 2 then 
       ...
       reaper.SetExtState(name,"play_cursor",A,true)
       ChangeBufferSize()
    else
       ChangeBufferSize()
