  ...
  local function main()
      ...
      repeat
          ...
          if backleg==pos_b then
             reaper.GetSet_LoopTimeRange2(0,true,false,pos_b,frontleg,false)
             return
          end
      until backleg>=pos_b or (reaper.time_precise()-time)>3
      
      pos_c=pos_b+(pos_b-pos_a)
      
      reaper.GetSet_LoopTimeRange2(0,true,false,pos_b,pos_c,false)
